    ...
    <div class="wrapper">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <table>
                <tr>
                    <td>Title</td>
                    <td><input type="text" name="title" placeholder="Medicine Title"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="description" id="" cols="30" rows="5"
                            placeholder="Description of the medicine."></textarea>
                    </td>
                </tr>
        ...
        ?>
                ...
                <tr>
                    <td>
                        <input class="btn btn-success" type="submit" name="submit" value="Add Medicine">
                    </td>
                </tr>
            </table>
        </form>
