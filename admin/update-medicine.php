...
?>
                ...
                <tr>
                    <td>
                        ...
                        <input class="btn btn-success" type="submit" name="submit" value="Update Medicine">
                    </td>
                </tr>
            </table>
        </form>
        ...
        if(isset($_POST['submit']))
        {
            ...
            if(isset($_FILES['image']['name']))
            {
                    ...
                    //Rename the image
                    $image_name="Medicine-Name-".rand(0000,9999).'.'.$ext;  //Medicine_Category_798.jpg
            
            
            
                    $src_path=$_FILES['image']['tmp_name'];
            
                    $dest_path="../images/medicine/".$image_name;
                ...
                //Update the database
                $sql3="UPDATE tbl_medicine SET title='$title',image_name='$image_name',description='$description',price=$price,image_name='$image_name',category_id='$category',featured='$featured',active='$active' WHERE id=$id";
